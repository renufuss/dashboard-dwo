            ...
            <div class="row gx-5 gx-xl-10">
                ...
                <div class="col-xxl-6 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body pt-0 pb-1">
                            <div id="showDayQTY" class="min-h-auto"></div>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Chart widget 27-->
                ...
                <div class="col-xxl-6 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header py-7">
                            <!--begin::Statistics-->
                            <select class="form-select form-select-solid" style="cursor: pointer;" name="name" id="name" data-control="select2" data-hide-search="true" data-placeholder="Pilih Negara...">
...
<script>
    var KTChartsWidget27 = function() {
        var e = {
            ...
            t = function(e) {
                var t = document.getElementById("showDayQTY");
                if (t) {
    ...
    function showProductDay() {
        $.ajax({
            type: "post",
            url: "/production/time/day",
            data: {
                name: $('#name').val(),
            },
            dataType: "json",
            ...
            success: function(response) {
                $('.showProductDay').html(response.showProductDay);
            }
        });
    }
</script>
