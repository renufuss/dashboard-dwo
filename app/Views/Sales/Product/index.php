                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header py-7">
                            ...
                            <div class="m-0">
                                ...
                                <!--end::Heading-->
                                <!--begin::Description-->
                                <span class="fs-6 fw-semibold text-gray-400">Total Sales</span>
                                <!--end::Description-->
                            </div>
                            <!--end::Statistics-->
                        </div>
                ...
                <div class="col-xxl-6 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                            <div class="countrySalesProduct"></div>
                        </div>
                        <!--end::Body-->
...
<script>
    ...
    $(document).ready(function() {
        countrySalesProductChart();
    });

    function countrySalesProductChart() {
        $.ajax({
            type: "post",
            url: "/sales/product/country",
            data: {
                country: $('#country').val(),
            },
            dataType: "json",
            beforeSend: function() {
                $(".countrySalesProduct").html(`
            ...
            success: function(response) {
                $('.countrySalesProduct').html(response.countrySalesProductChart);
            }
        });
    }
</script>
