...
var KTWidgets = {
    init: function () {
        ...
        ! function () {
            ...
            })), (s = document.querySelector("#kt_user_follow_button")) && s.addEventListener("click", (function (e) {
                e.preventDefault(), s.setAttribute("data-kt-indicator", "on"), s.disabled = !0, s.classList.contains("btn-success") ? setTimeout((function () {
                    s.removeAttribute("data-kt-indicator"), s.classList.remove("btn-success"), s.classList.add("btn-light"), s.querySelector(".svg-icon").classList.add("d-none"), s.querySelector(".indicator-label").innerHTML = "Follow", s.disabled = !1
                }), 1500) : setTimeout((function () {
                    s.removeAttribute("data-kt-indicator"), s.classList.add("btn-success"), s.classList.remove("btn-light"), s.querySelector(".svg-icon").classList.remove("d-none"), s.querySelector(".indicator-label").innerHTML = "Following", s.disabled = !1
                }), 1e3)
            })),
            function () {
